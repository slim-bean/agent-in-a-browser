...
function trampoline30(arg0, arg1, arg2, arg3, arg4, arg5) {
  var handle1 = arg0;
  var rep2 = handleTable4[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable4.get(rep2);
  if (!rsc0) {
...
const trampoline38 = new WebAssembly.Suspending(async function(arg0, arg1) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline45 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13) {
  var ptr0 = arg0;
  var len0 = arg1;
  ...
  _debugLog('[iface="codex:agent/shell-exec@0.1.0", function="exec"] [Instruction::CallInterface] (async? sync, @ enter)');
  ...
  _debugLog('[iface="codex:agent/shell-exec@0.1.0", function="exec"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant14 = ret;
  ...
  _debugLog('[iface="codex:agent/shell-exec@0.1.0", function="exec"][Instruction::Return]', {
    funcName: 'exec',
    paramCount: 0,
    async: false,
    postReturn: false
...
const trampoline55 = new WebAssembly.Suspending(async function(arg0, arg1) {
  var handle1 = arg0;
  var rep2 = handleTable11[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable11.get(rep2);
  if (!rsc0) {
...
const trampoline56 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4) {
  var handle1 = arg0;
  var rep2 = handleTable11[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable11.get(rep2);
  if (!rsc0) {
...
const trampoline57 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
  var rep2 = handleTable11[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable11.get(rep2);
  if (!rsc0) {
...
const trampoline59 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable11[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable11.get(rep2);
  if (!rsc0) {
...
const trampoline60 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
  var rep2 = handleTable11[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable11.get(rep2);
  if (!rsc0) {
  ...
  var result3 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr3, len3));
  var handle5 = arg3;
  var rep6 = handleTable11[(handle5 << 1) + 1] & ~T_FLAG;
  var rsc4 = captureTable11.get(rep6);
  if (!rsc4) {
...
const trampoline61 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable11[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable11.get(rep2);
  if (!rsc0) {
...
async function create(arg0) {
  ...
  const ret = await exports1Create(ptr0);
  endCurrentTask(0);
  let variant19;
...
async function destroy(arg0) {
  ...
  await exports1Destroy(toUint32(arg0));
  endCurrentTask(0);
...
let exports1SendMessage;

function sendMessage(arg0, arg1) {
  var ptr0 = utf8Encode(arg1, realloc0, memory0);
  var len0 = utf8EncodedLen;
  _debugLog('[iface="send-message", function="send-message"][Instruction::CallWasm] enter', {
    funcName: 'send-message',
    paramCount: 3,
    async: false,
    postReturn: true,
  });
  const _wasm_call_currentTaskID = startCurrentTask(0, false, 'exports1SendMessage');
  const ret = exports1SendMessage(toUint32(arg0), ptr0, len0);
  endCurrentTask(0);
  let variant2;
  if (dataView(memory0).getUint8(ret + 0, true)) {
  ...
  _debugLog('[iface="send-message", function="send-message"][Instruction::Return]', {
    funcName: 'send-message',
    paramCount: 1,
    async: false,
    postReturn: true
...
async function poll(arg0) {
  ...
  const ret = await exports1Poll(toUint32(arg0));
  endCurrentTask(0);
  let variant20;
  if (dataView(memory0).getUint8(ret + 0, true)) {
    let variant19;
...
async function cancel(arg0) {
  ...
  await exports1Cancel(toUint32(arg0));
  endCurrentTask(0);
...
async function plan(arg0, arg1) {
  ...
  const ret = await exports1Plan(toUint32(arg0), ptr0, len0);
  endCurrentTask(0);
  let variant2;
  if (dataView(memory0).getUint8(ret + 0, true)) {
    var ptr1 = dataView(memory0).getUint32(ret + 4, true);
...
async function execute(arg0) {
  ...
  const ret = await exports1Execute(toUint32(arg0));
  endCurrentTask(0);
  let variant1;
  if (dataView(memory0).getUint8(ret + 0, true)) {
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./codex-wasm-agent.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module1));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'codex:agent/shell-exec@0.1.0': {
        exec: exports0['15'],
      },
      ...
      'wasi:clocks/monotonic-clock@0.2.0': {
        now: trampoline27,
        'subscribe-duration': trampoline29,
        'subscribe-instant': trampoline28,
      },
      ...
      'wasi:filesystem/types@0.2.0': {
        '[method]descriptor.append-via-stream': exports0['21'],
        ...
        '[method]descriptor.open-at': exports0['27'],
        '[method]descriptor.read-directory': exports0['23'],
        '[method]descriptor.read-via-stream': exports0['19'],
        '[method]descriptor.readlink-at': exports0['28'],
        '[method]descriptor.remove-directory-at': exports0['29'],
        '[method]descriptor.rename-at': exports0['30'],
        '[method]descriptor.stat': exports0['25'],
        '[method]descriptor.stat-at': exports0['26'],
        '[method]descriptor.unlink-file-at': exports0['31'],
        '[method]descriptor.write-via-stream': exports0['20'],
        '[method]directory-entry-stream.read-directory-entry': exports0['34'],
        '[resource-drop]descriptor': trampoline20,
        '[resource-drop]directory-entry-stream': trampoline21,
      },
      ...
      'wasi:http/types@0.2.9': {
        ...
        '[method]fields.entries': exports0['9'],
        ...
        '[method]incoming-response.headers': trampoline5,
        '[method]incoming-response.status': trampoline4,
        ...
        '[resource-drop]incoming-body': trampoline7,
    ...
    exports1Create = WebAssembly.promising(exports1.create);
    exports1Destroy = WebAssembly.promising(exports1.destroy);
    exports1SendMessage = exports1['send-message'];
    exports1Poll = WebAssembly.promising(exports1.poll);
    exports1Cancel = WebAssembly.promising(exports1.cancel);
    exports1Plan = WebAssembly.promising(exports1.plan);
    exports1Execute = WebAssembly.promising(exports1.execute);
...
export { cancel, clearHistory, create, destroy, execute, fetchModels, getHistory, listModels, listProviders, plan, poll, sendMessage,  }