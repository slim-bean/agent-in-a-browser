//! wasip2-compatible shim for tokio-tungstenite.
//!
//! Provides the `tungstenite::Error` and `tungstenite::Message` types used
//! in codex API telemetry and client type signatures. No actual WebSocket
//! functionality — codex-tui uses a WIT-based WebSocket backend instead.
