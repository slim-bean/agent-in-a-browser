...
#[doc(hidden)]
pub(crate) use __export_world_codex_tui_cabi;
#[rustfmt::skip]
        ...
        pub mod shell_exec {
            ...
            pub fn exec(
                ...
                unsafe {
                    ...
                    #[link(wasm_import_module = "codex:tui/shell-exec@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "exec"]
                        fn wit_import13(
                            _: *mut u8,
        ...
        pub mod websocket {
            ...
            pub fn connect(
                ...
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "codex:tui/websocket@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "connect"]
                        fn wit_import4(
                            _: *mut u8,
        ...
        pub mod credential_store {
            ...
            pub fn load(
                ...
                unsafe {
                    ...
                    let ptr2 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "codex:tui/credential-store@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "load"]
                        fn wit_import3(
                            _: *mut u8,
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_codex_tui_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_codex_tui_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
pub(crate) use __export_codex_tui_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:codex:tui@0.1.0:codex-tui:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 12781] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xedb\x01A\x02\x01AQ\x01\
...
\x04\0\x0dstart-capture\x01\x08\x01p}\x01j\x01\x09\x01s\x01@\x01\x0acapture-idy\0\
\x0a\x04\0\x11read-capture-data\x01\x0b\x01@\x01\x0acapture-idy\0{\x04\0\x10get-\
capture-peak\x01\x0c\x01j\0\x01s\x01@\x01\x0acapture-idy\0\x0d\x04\0\x0cstop-cap\
...
\x04\0\x05error\x01\0\x03\0\x1ahost:console/logging@0.1.0\x05*\x01B\x0a\x01ks\x01\
j\x01\0\x01s\x01@\x02\x07services\x07accounts\0\x01\x04\0\x04load\x01\x02\x01j\0\
\x01s\x01@\x03\x07services\x07accounts\x05values\0\x03\x04\0\x04save\x01\x04\x01\
j\x01\x7f\x01s\x01@\x02\x07services\x07accounts\0\x05\x04\0\x11delete-credential\
\x01\x06\x03\0\x20codex:tui/credential-store@0.1.0\x05+\x01@\0\0z\x04\0\x03run\x01\
,\x01o\x02ss\x01p-\x01p}\x01@\x04\x06methods\x04paths\x07headers.\x04body/\x01\0\
\x04\0\x12push-auth-callback\x010\x04\0\x19codex:tui/codex-tui@0.1.0\x04\0\x0b\x0f\
\x01\0\x09codex-tui\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-compo\
