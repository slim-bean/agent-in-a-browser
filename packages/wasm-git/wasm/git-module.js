...
function trampoline0(arg0) {
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="response-status"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'response-status');
  const ret = responseStatus(arg0 >>> 0);
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="response-status"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="response-status"][Instruction::Return]', {
...
function trampoline1(arg0) {
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="response-close"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'response-close');
  responseClose(arg0 >>> 0);
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="response-close"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="response-close"][Instruction::Return]', {
...
const trampoline19 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
  ...
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="request"] [Instruction::CallInterface] (async? sync, @ enter)');
  ...
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="request"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="request"][Instruction::Return]', {
    funcName: 'request',
    paramCount: 1,
    async: false,
    postReturn: false
...
function trampoline20(arg0, arg1) {
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="response-headers"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'response-headers');
  const ret = responseHeaders(arg0 >>> 0);
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="response-headers"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  ...
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="response-headers"][Instruction::Return]', {
...
function trampoline21(arg0, arg1, arg2) {
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="response-body-read"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'response-body-read');
  const ret = responseBodyRead(arg0 >>> 0, arg1 >>> 0);
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="response-body-read"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var val0 = ret;
  ...
  _debugLog('[iface="git:bridge/http-bridge@0.1.0", function="response-body-read"][Instruction::Return]', {
...
const trampoline27 = new WebAssembly.Suspending(async function(arg0, arg1) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline28 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline29 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline30 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline31 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline32 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline33 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline46 = new WebAssembly.Suspending(async function(arg0, arg1, arg2) {
  var handle1 = arg0;
  var rep2 = handleTable2[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable2.get(rep2);
  if (!rsc0) {
...
const trampoline48 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable3[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable3.get(rep2);
  if (!rsc0) {
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./git-module.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./git-module.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module2));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'git:bridge/http-bridge@0.1.0': {
        request: exports0['30'],
        'response-body-read': exports0['32'],
        'response-close': trampoline1,
        'response-headers': exports0['31'],
      ...
      wasi_snapshot_preview1: {
        ...
        fd_fdstat_set_flags: exports0['26'],
        ...
        'path_remove_directory [v2]': exports0['20'],
        path_rename: exports0['21'],
        path_symlink: exports0['22'],
        path_unlink_file: exports0['23'],
        'path_unlink_file [v2]': exports0['23'],
    ...
    ({ exports: exports2 } = yield instantiateCore(yield module1, {
      ...
      'wasi:cli/environment@0.2.6': {
        'get-arguments': exports0['61'],
        'get-environment': exports0['62'],
      },
      'wasi:cli/exit@0.2.6': {
        exit: trampoline18,
      },
      ...
      'wasi:filesystem/preopens@0.2.6': {
        'get-directories': exports0['60'],
      },
      'wasi:filesystem/types@0.2.6': {
        '[method]descriptor.append-via-stream': exports0['51'],
        '[method]descriptor.create-directory-at': exports0['39'],
        '[method]descriptor.get-flags': exports0['35'],
        '[method]descriptor.get-type': exports0['53'],
        ...
        '[method]descriptor.read': exports0['37'],
        '[method]descriptor.read-directory': exports0['38'],
        '[method]descriptor.read-via-stream': exports0['46'],
        '[method]descriptor.readlink-at': exports0['48'],
        '[method]descriptor.remove-directory-at': exports0['42'],
        '[method]descriptor.rename-at': exports0['43'],
        '[method]descriptor.set-size': exports0['36'],
        '[method]descriptor.stat': exports0['52'],
        '[method]descriptor.stat-at': exports0['40'],
        '[method]descriptor.symlink-at': exports0['44'],
        '[method]descriptor.unlink-file-at': exports0['45'],
        '[method]descriptor.write-via-stream': exports0['47'],
        '[method]directory-entry-stream.read-directory-entry': exports0['33'],
        '[resource-drop]descriptor': trampoline5,
        '[resource-drop]directory-entry-stream': trampoline4,
        'filesystem-error-code': exports0['34'],
      },
      'wasi:io/error@0.2.6': {
    ...
    ({ exports: exports3 } = yield instantiateCore(yield module3, {
      '': {
        ...
        '22': exports2.path_symlink,
        '23': exports2.path_unlink_file,
        '24': exports2.path_open,
        '25': exports2.fd_fdstat_get,
        '26': exports2.fd_fdstat_set_flags,
        '27': exports2.fd_prestat_get,
        '28': exports2.fd_prestat_dir_name,
        '29': exports2.sock_shutdown,
