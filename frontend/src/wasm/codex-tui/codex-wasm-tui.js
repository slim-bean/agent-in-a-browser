import { clearPlayback, defaultInputConfig, defaultOutputConfig, enqueuePlayback, listInputDevices, listOutputDevices, readCaptureData, startCapture, startPlayback, stopCapture, stopPlayback } from '@tjfontaine/wasi-shims/audio-impl.js';
import { openUrl } from '@tjfontaine/wasi-shims/browser-impl.js';
import { writeText } from '@tjfontaine/wasi-shims/clipboard-impl.js';
import { monotonicClock, wallClock } from '@tjfontaine/wasi-shims/clocks-impl.js';
import { error, log, warn } from '@tjfontaine/wasi-shims/console-logging-impl.js';
import { deleteCredential, load, save } from '@tjfontaine/wasi-shims/credential-store-impl.js';
import { error as error$1 } from '@tjfontaine/wasi-shims/error.js';
import { environment, exit as exit$1, size, stderr, stdin, stdout, terminalInput, terminalOutput, terminalStderr, terminalStdin, terminalStdout } from '@tjfontaine/wasi-shims/ghostty-cli-shim.js';
...
function trampoline0(arg0) {
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="close"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'close');
  close(arg0 >>> 0);
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="close"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="close"][Instruction::Return]', {
    funcName: 'close',
    paramCount: 0,
    async: false,
    postReturn: false
...
function trampoline1(arg0) {
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="is-closed"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'is-closed');
  const ret = isClosed(arg0 >>> 0);
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="is-closed"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="is-closed"][Instruction::Return]', {
    funcName: 'is-closed',
    paramCount: 1,
    async: false,
    postReturn: false
...
function trampoline7(arg0, arg1, arg2) {
  ...
  _debugLog('[iface="wasi:http/types@0.2.9", function="[method]request-options.set-connect-timeout"] [Instruction::CallInterface] (async? sync, @ enter)');
  ...
  _debugLog('[iface="wasi:http/types@0.2.9", function="[method]request-options.set-connect-timeout"] [Instruction::CallInterface] (sync, @ post-call)');
  for (const rsc of curResourceBorrows) {
    rsc[symbolRscHandle] = undefined;
  }
  curResourceBorrows = [];
  ...
  _debugLog('[iface="wasi:http/types@0.2.9", function="[method]request-options.set-connect-timeout"][Instruction::Return]', {
...
function trampoline8(arg0, arg1, arg2) {
  ...
  _debugLog('[iface="wasi:http/types@0.2.9", function="[method]request-options.set-first-byte-timeout"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, '[method]request-options.set-first-byte-timeout');
  let ret;
  try {
    ret = { tag: 'ok', val: rsc0.setFirstByteTimeout(variant3)};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="wasi:http/types@0.2.9", function="[method]request-options.set-first-byte-timeout"] [Instruction::CallInterface] (sync, @ post-call)');
  for (const rsc of curResourceBorrows) {
    rsc[symbolRscHandle] = undefined;
  }
  curResourceBorrows = [];
  ...
  _debugLog('[iface="wasi:http/types@0.2.9", function="[method]request-options.set-first-byte-timeout"][Instruction::Return]', {
...
function trampoline9(arg0, arg1, arg2) {
  ...
  _debugLog('[iface="wasi:http/types@0.2.9", function="[method]request-options.set-between-bytes-timeout"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, '[method]request-options.set-between-bytes-timeout');
  let ret;
  try {
    ret = { tag: 'ok', val: rsc0.setBetweenBytesTimeout(variant3)};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="wasi:http/types@0.2.9", function="[method]request-options.set-between-bytes-timeout"] [Instruction::CallInterface] (sync, @ post-call)');
  for (const rsc of curResourceBorrows) {
    rsc[symbolRscHandle] = undefined;
  }
  curResourceBorrows = [];
  ...
  _debugLog('[iface="wasi:http/types@0.2.9", function="[method]request-options.set-between-bytes-timeout"][Instruction::Return]', {
...
function trampoline36(arg0) {
  _debugLog('[iface="wasi:clocks/monotonic-clock@0.2.9", function="subscribe-instant"] [Instruction::CallInterface] (async? sync, @ enter)');
  ...
  _debugLog('[iface="wasi:clocks/monotonic-clock@0.2.9", function="subscribe-instant"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  if (!(ret ?.[Symbol.for('wasi:io/poll@0.2.9#Pollable')])) {
    throw new TypeError('Resource error: Not a valid "Pollable" resource.');
  }
...
function trampoline37(arg0, arg1) {
  ...
  _debugLog('[iface="host:console/logging@0.1.0", function="log"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'log');
  log(result0);
  _debugLog('[iface="host:console/logging@0.1.0", function="log"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  _debugLog('[iface="host:console/logging@0.1.0", function="log"][Instruction::Return]', {
    funcName: 'log',
    paramCount: 0,
    async: false,
    postReturn: false
...
function trampoline38(arg0, arg1) {
  ...
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="host:console/logging@0.1.0", function="error"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'error');
  error(result0);
  _debugLog('[iface="host:console/logging@0.1.0", function="error"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  _debugLog('[iface="host:console/logging@0.1.0", function="error"][Instruction::Return]', {
    funcName: 'error',
    paramCount: 0,
    async: false,
    postReturn: false
...
function trampoline39(arg0, arg1) {
  ...
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="host:console/logging@0.1.0", function="warn"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'warn');
  warn(result0);
  _debugLog('[iface="host:console/logging@0.1.0", function="warn"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  _debugLog('[iface="host:console/logging@0.1.0", function="warn"][Instruction::Return]', {
    funcName: 'warn',
    paramCount: 0,
    async: false,
    postReturn: false
...
const trampoline40 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  var len2 = arg3;
  ...
  _debugLog('[iface="codex:tui/shell-exec@0.1.0", function="exec"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'exec');
  let ret;
  try {
    ret = { tag: 'ok', val: await exec(result0, result2, {
      cwd: result3,
      vars: result6,
    }, variant8, variant9)};
  } catch (e) {
  ...
  _debugLog('[iface="codex:tui/shell-exec@0.1.0", function="exec"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant14 = ret;
  switch (variant14.tag) {
    case 'ok': {
      const e = variant14.val;
      dataView(memory0).setInt8(arg13 + 0, 0, true);
      var {exitCode: v10_0, stdout: v10_1, stderr: v10_2 } = e;
      dataView(memory0).setInt32(arg13 + 4, toInt32(v10_0), true);
      var val11 = v10_1;
      var len11 = val11.byteLength;
      var ptr11 = realloc0(0, 0, 1, len11 * 1);
      var src11 = new Uint8Array(val11.buffer || val11, val11.byteOffset, len11 * 1);
      (new Uint8Array(memory0.buffer, ptr11, len11 * 1)).set(src11);
      dataView(memory0).setUint32(arg13 + 12, len11, true);
      dataView(memory0).setUint32(arg13 + 8, ptr11, true);
      var val12 = v10_2;
      ...
      dataView(memory0).setUint32(arg13 + 20, len12, true);
      dataView(memory0).setUint32(arg13 + 16, ptr12, true);
      break;
    }
    case 'err': {
      const e = variant14.val;
      dataView(memory0).setInt8(arg13 + 0, 1, true);
      var ptr13 = utf8Encode(e, realloc0, memory0);
      var len13 = utf8EncodedLen;
      dataView(memory0).setUint32(arg13 + 8, len13, true);
      dataView(memory0).setUint32(arg13 + 4, ptr13, true);
      break;
    }
    default: {
      throw new TypeError('invalid variant specified for result');
  ...
  _debugLog('[iface="codex:tui/shell-exec@0.1.0", function="exec"][Instruction::Return]', {
    funcName: 'exec',
    paramCount: 0,
    async: false,
    postReturn: false
...
const trampoline41 = new WebAssembly.Suspending(async function(arg0, arg1) {
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="recv"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'recv');
  let ret;
  try {
    ret = { tag: 'ok', val: await recv(arg0 >>> 0)};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="recv"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant3 = ret;
  switch (variant3.tag) {
    case 'ok': {
      ...
      if (variant1 === null || variant1=== undefined) {
        ...
        dataView(memory0).setUint32(arg1 + 12, len0, true);
        dataView(memory0).setUint32(arg1 + 8, ptr0, true);
      }
      break;
    }
    case 'err': {
      ...
      dataView(memory0).setUint32(arg1 + 8, len2, true);
      dataView(memory0).setUint32(arg1 + 4, ptr2, true);
      break;
    }
    default: {
      throw new TypeError('invalid variant specified for result');
  ...
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="recv"][Instruction::Return]', {
    funcName: 'recv',
    paramCount: 0,
    async: false,
    postReturn: false
...
function trampoline42(arg0, arg1, arg2, arg3) {
  ...
  var len0 = arg2;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="send"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'send');
  let ret;
  try {
    ret = { tag: 'ok', val: send(arg0 >>> 0, result0)};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="send"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant2 = ret;
  switch (variant2.tag) {
    case 'ok': {
  ...
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="send"][Instruction::Return]', {
    funcName: 'send',
    paramCount: 0,
    async: false,
    postReturn: false
...
const trampoline43 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  var len2 = arg3;
  ...
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="connect"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'connect');
  let ret;
  try {
    ret = { tag: 'ok', val: await connect(result0, result2)};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="connect"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant4 = ret;
  switch (variant4.tag) {
    case 'ok': {
    ...
    case 'err': {
      ...
      dataView(memory0).setUint32(arg4 + 8, len3, true);
      dataView(memory0).setUint32(arg4 + 4, ptr3, true);
      break;
    }
    default: {
      throw new TypeError('invalid variant specified for result');
  ...
  _debugLog('[iface="codex:tui/websocket@0.1.0", function="connect"][Instruction::Return]', {
    funcName: 'connect',
    paramCount: 0,
    async: false,
    postReturn: false
...
const trampoline52 = new WebAssembly.Suspending(async function(arg0, arg1) {
  var handle1 = arg0;
  var rep2 = handleTable10[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable10.get(rep2);
  if (!rsc0) {
...
const trampoline57 = new WebAssembly.Suspending(async function(arg0, arg1, arg2) {
  var handle1 = arg0;
  var rep2 = handleTable3[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable3.get(rep2);
  if (!rsc0) {
...
const trampoline58 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
  ...
  if (arg1) {
    ...
    if (!rsc3) {
      ...
      captureTable9.delete(rep5);
    }
    rscTableRemove(handleTable9, handle4);
    variant6 = rsc3;
  } else {
    variant6 = undefined;
  }
  ...
  let ret;
  try {
    ret = { tag: 'ok', val: await handle(rsc0, variant6)};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
...
function trampoline62(arg0) {
  ...
  let ret;
  try {
    ret = { tag: 'ok', val: defaultOutputConfig()};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="host:browser/audio@0.1.0", function="default-output-config"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant2 = ret;
  switch (variant2.tag) {
    case 'ok': {
      ...
      var [tuple0_0, tuple0_1, tuple0_2] = e;
      dataView(memory0).setInt32(arg0 + 4, toUint32(tuple0_0), true);
      dataView(memory0).setInt16(arg0 + 8, toUint16(tuple0_1), true);
      dataView(memory0).setInt8(arg0 + 10, toUint8(tuple0_2), true);
      break;
    }
    case 'err': {
      const e = variant2.val;
  ...
  _debugLog('[iface="host:browser/audio@0.1.0", function="default-output-config"][Instruction::Return]', {
    funcName: 'default-output-config',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
function trampoline63(arg0) {
  ...
  let ret;
  try {
    ret = { tag: 'ok', val: defaultInputConfig()};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="host:browser/audio@0.1.0", function="default-input-config"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant2 = ret;
  switch (variant2.tag) {
    case 'ok': {
  ...
  _debugLog('[iface="host:browser/audio@0.1.0", function="default-input-config"][Instruction::Return]', {
    funcName: 'default-input-config',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
const trampoline67 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5) {
  let variant1;
  if (arg0) {
    var ptr0 = arg1;
    var len0 = arg2;
  ...
  _debugLog('[iface="host:browser/audio@0.1.0", function="start-capture"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'start-capture');
  let ret;
  try {
    ret = { tag: 'ok', val: await startCapture(variant1, arg3 >>> 0, clampGuest(arg4, 0, 65535))};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="host:browser/audio@0.1.0", function="start-capture"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant3 = ret;
  switch (variant3.tag) {
    case 'ok': {
  ...
  _debugLog('[iface="host:browser/audio@0.1.0", function="start-capture"][Instruction::Return]', {
    funcName: 'start-capture',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
const trampoline68 = new WebAssembly.Suspending(async function(arg0, arg1) {
...
const trampoline71 = new WebAssembly.Suspending(async function(arg0, arg1, arg2) {
  ...
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="host:browser/clipboard@0.1.0", function="write-text"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'write-text');
  let ret;
  try {
    ret = { tag: 'ok', val: await writeText(result0)};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="host:browser/clipboard@0.1.0", function="write-text"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant2 = ret;
  switch (variant2.tag) {
    case 'ok': {
  ...
  _debugLog('[iface="host:browser/clipboard@0.1.0", function="write-text"][Instruction::Return]', {
    funcName: 'write-text',
    paramCount: 0,
    async: false,
    postReturn: false
...
const trampoline74 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  var len2 = arg3;
...
const trampoline75 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  let variant1;
...
const trampoline76 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  var ptr1 = arg2;
...
const trampoline77 = new WebAssembly.Suspending(async function(arg0, arg1, arg2) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
...
const trampoline78 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  var ptr1 = arg2;
  var len1 = arg3;
  var result1 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr1, len1));
  _debugLog('[iface="codex:tui/credential-store@0.1.0", function="load"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'load');
  let ret;
  try {
    ret = { tag: 'ok', val: await load(result0, result1)};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="codex:tui/credential-store@0.1.0", function="load"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant5 = ret;
  switch (variant5.tag) {
    case 'ok': {
  ...
  _debugLog('[iface="codex:tui/credential-store@0.1.0", function="load"][Instruction::Return]', {
    funcName: 'load',
    paramCount: 0,
    async: false,
    postReturn: false
...
const trampoline79 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  var ptr1 = arg2;
  ...
  _debugLog('[iface="codex:tui/credential-store@0.1.0", function="save"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'save');
  let ret;
  try {
    ret = { tag: 'ok', val: await save(result0, result1, result2)};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="codex:tui/credential-store@0.1.0", function="save"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant4 = ret;
  switch (variant4.tag) {
    case 'ok': {
  ...
  _debugLog('[iface="codex:tui/credential-store@0.1.0", function="save"][Instruction::Return]', {
    funcName: 'save',
    paramCount: 0,
    async: false,
    postReturn: false
...
const trampoline80 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  var ptr1 = arg2;
  var len1 = arg3;
  var result1 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr1, len1));
  _debugLog('[iface="codex:tui/credential-store@0.1.0", function="delete-credential"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'delete-credential');
  let ret;
  try {
    ret = { tag: 'ok', val: await deleteCredential(result0, result1)};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="codex:tui/credential-store@0.1.0", function="delete-credential"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant3 = ret;
  switch (variant3.tag) {
    case 'ok': {
      const e = variant3.val;
      dataView(memory0).setInt8(arg4 + 0, 0, true);
      dataView(memory0).setInt8(arg4 + 4, e ? 1 : 0, true);
      break;
    }
    case 'err': {
      const e = variant3.val;
  ...
  _debugLog('[iface="codex:tui/credential-store@0.1.0", function="delete-credential"][Instruction::Return]', {
    funcName: 'delete-credential',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
function trampoline90(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.set-times"] [Instruction::CallInterface] (async? sync, @ enter)');
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.set-times"] [Instruction::CallInterface] (sync, @ post-call)');
  for (const rsc of curResourceBorrows) {
    rsc[symbolRscHandle] = undefined;
  }
  curResourceBorrows = [];
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.set-times"][Instruction::Return]', {
...
function trampoline92(arg0, arg1) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.sync"] [Instruction::CallInterface] (async? sync, @ enter)');
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.sync"] [Instruction::CallInterface] (sync, @ post-call)');
  for (const rsc of curResourceBorrows) {
    rsc[symbolRscHandle] = undefined;
  }
  curResourceBorrows = [];
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.sync"][Instruction::Return]', {
...
const trampoline93 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
const trampoline95 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
function trampoline96(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.set-times-at"] [Instruction::CallInterface] (async? sync, @ enter)');
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.set-times-at"] [Instruction::CallInterface] (sync, @ post-call)');
  for (const rsc of curResourceBorrows) {
    rsc[symbolRscHandle] = undefined;
  }
  curResourceBorrows = [];
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.set-times-at"][Instruction::Return]', {
...
const trampoline97 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
const trampoline99 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
const trampoline100 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
  ...
  var result3 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr3, len3));
  var handle5 = arg3;
  var rep6 = handleTable13[(handle5 << 1) + 1] & ~T_FLAG;
  var rsc4 = captureTable13.get(rep6);
  if (!rsc4) {
...
function trampoline103(arg0, arg1, arg2, arg3, arg4) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
const trampoline111 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable2[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable2.get(rep2);
  if (!rsc0) {
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    ...
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module2));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'codex:tui/credential-store@0.1.0': {
        'delete-credential': exports0['43'],
        load: exports0['41'],
        save: exports0['42'],
      },
      ...
      'codex:tui/shell-pty@0.1.0': {
        'poll-wake': exports0['36'],
        read: exports0['38'],
        start: exports0['37'],
        terminate: exports0['40'],
        write: exports0['39'],
      },
      'codex:tui/websocket@0.1.0': {
        close: trampoline0,
        connect: exports0['6'],
        'is-closed': trampoline1,
        recv: exports0['4'],
        send: exports0['5'],
      },
      'host:browser/actions@0.1.0': {
        'open-url': exports0['35'],
      },
      'host:browser/audio@0.1.0': {
        'clear-playback': exports0['23'],
        'default-input-config': exports0['26'],
        'default-output-config': exports0['25'],
        'enqueue-playback': exports0['28'],
        'list-input-devices': exports0['33'],
        'list-output-devices': exports0['32'],
        'read-capture-data': exports0['31'],
        'start-capture': exports0['30'],
        'start-playback': exports0['27'],
        'stop-capture': exports0['29'],
        'stop-playback': exports0['24'],
      },
      'host:browser/clipboard@0.1.0': {
        'write-text': exports0['34'],
      },
      ...
      'wasi:clocks/monotonic-clock@0.2.0': {
        ...
        'subscribe-instant': trampoline36,
      },
      ...
      'wasi:filesystem/types@0.2.0': {
        '[method]descriptor.append-via-stream': exports0['51'],
        '[method]descriptor.create-directory-at': exports0['57'],
        '[method]descriptor.get-flags': exports0['52'],
        '[method]descriptor.metadata-hash': exports0['66'],
        '[method]descriptor.metadata-hash-at': exports0['67'],
        '[method]descriptor.open-at': exports0['61'],
        '[method]descriptor.read-directory': exports0['55'],
        '[method]descriptor.read-via-stream': exports0['49'],
        ...
        '[method]descriptor.set-size': exports0['53'],
        '[method]descriptor.set-times': exports0['54'],
        '[method]descriptor.set-times-at': exports0['60'],
        '[method]descriptor.stat': exports0['58'],
        '[method]descriptor.stat-at': exports0['59'],
        '[method]descriptor.sync': exports0['56'],
        '[method]descriptor.unlink-file-at': exports0['65'],
        '[method]descriptor.write-via-stream': exports0['50'],
        '[method]directory-entry-stream.read-directory-entry': exports0['68'],
      ...
      'wasi:http/types@0.2.9': {
        ...
        '[constructor]request-options': trampoline6,
        '[method]fields.append': exports0['7'],
        '[method]fields.entries': exports0['16'],
        '[method]future-incoming-response.get': exports0['15'],
        '[method]future-incoming-response.subscribe': trampoline11,
        '[method]incoming-body.stream': exports0['17'],
        '[method]incoming-response.consume': exports0['18'],
        '[method]incoming-response.headers': trampoline13,
        '[method]incoming-response.status': trampoline15,
        '[method]outgoing-body.write': exports0['13'],
        ...
        '[method]request-options.set-between-bytes-timeout': trampoline9,
        '[method]request-options.set-connect-timeout': trampoline7,
        '[method]request-options.set-first-byte-timeout': trampoline8,
        '[resource-drop]fields': trampoline17,
        '[resource-drop]future-incoming-response': trampoline12,
        '[resource-drop]incoming-body': trampoline20,
        '[resource-drop]incoming-response': trampoline24,
        '[resource-drop]outgoing-body': trampoline21,
        '[resource-drop]outgoing-request': trampoline23,
        '[resource-drop]request-options': trampoline10,
      ...
      'wasi:io/streams@0.2.0': {
        ...
        '[method]output-stream.blocking-flush': exports0['48'],
        '[method]output-stream.check-write': exports0['47'],
    ...
    ({ exports: exports2 } = yield instantiateCore(yield module1, {
      ...
      'wasi:io/streams@0.2.6': {
        '[method]output-stream.blocking-write-and-flush': exports0['75'],
        '[resource-drop]output-stream': trampoline22,
      },
      'wasi:random/random@0.2.6': {
        'get-random-bytes': exports0['76'],
      },
    }));
