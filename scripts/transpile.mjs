...
const MODULES = {
    ...
    'codex-wasm-tui': {
        ...
        shims: {
            ...
            'codex:tui/credential-store@0.1.0': '@tjfontaine/wasi-shims/credential-store-impl.js',
        },
        exports: ['run'],
        extraAsyncImports: [
            ...
            'host:browser/audio@0.1.0#start-playback',
            // Credential store
            'codex:tui/credential-store@0.1.0#load',
            'codex:tui/credential-store@0.1.0#save',
            'codex:tui/credential-store@0.1.0#delete-credential',
        ],
    },
    'codex-wasm-app-server': {
        wasm: 'codex_wasm_app_server.wasm',
        jspiOut: `${FRONTEND}/src/wasm/codex-app-server`,
        syncOut: `${FRONTEND}/src/wasm/codex-app-server-sync`,
        shims: {
            ...SHIMS,
            'codex:app-server/shell-exec@0.1.0': '@tjfontaine/wasi-shims/shell-exec-impl.js',
            'codex:app-server/shell-pty@0.1.0': '@tjfontaine/wasi-shims/shell-pty-impl.js',
            'codex:app-server/websocket@0.1.0': '@tjfontaine/wasi-shims/websocket-impl.js',
            'codex:app-server/event-sink@0.1.0': '@tjfontaine/wasi-shims/event-sink-impl.js',
        ...
        extraAsyncImports: [
            ...
            'codex:app-server/shell-pty@0.1.0#start',
            'codex:app-server/shell-pty@0.1.0#read',
            'codex:app-server/shell-pty@0.1.0#write',
            'codex:app-server/shell-pty@0.1.0#terminate',
            'codex:app-server/shell-pty@0.1.0#poll-wake',
            'codex:app-server/websocket@0.1.0#connect',
            'codex:app-server/websocket@0.1.0#recv',
            'codex:app-server/event-sink@0.1.0#emit-event',
            'wasi:io/streams@0.2.9#[method]input-stream.blocking-read',
            'wasi:http/outgoing-handler@0.2.9#handle',
            'host:browser/actions@0.1.0#open-url',
            'host:browser/clipboard@0.1.0#read-text',
            'host:browser/clipboard@0.1.0#write-text',
            // Credential store
            'codex:app-server/credential-store@0.1.0#load',
            'codex:app-server/credential-store@0.1.0#save',
            'codex:app-server/credential-store@0.1.0#delete-credential',
        ],
    },
};
