...
pub trait Guest {
    /// Initialize and start the app-server runtime.
...
#[doc(hidden)]
macro_rules! __export_world_codex_app_server_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        const _ : () = { #[unsafe (export_name = "start")] unsafe extern "C" fn
        export_start() -> i32 { unsafe { $($path_to_types)*:: _export_start_cabi::<$ty >
...
#[doc(hidden)]
pub(crate) use __export_world_codex_app_server_cabi;
#[rustfmt::skip]
...
pub mod codex {
    pub mod app_server {
        ...
        pub mod shell_exec {
            ...
            pub fn exec(
                ...
                unsafe {
                    ...
                    let (result10_0, result10_1, result10_2) = match stdin {
                        Some(e) => {
                            let vec9 = e;
                    ...
                    let (result11_0, result11_1) = match timeout_ms {
                        Some(e) => (1i32, _rt::as_i32(e)),
                        None => (0i32, 0i32),
                    };
                    let ptr12 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "codex:app-server/shell-exec@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "exec"]
                        fn wit_import13(
                            _: *mut u8,
        ...
        pub mod shell_pty {
            ...
            pub fn start(
                ...
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "codex:app-server/shell-pty@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "start"]
                        fn wit_import10(
                            _: *mut u8,
        ...
        pub mod websocket {
            ...
            pub fn connect(
                ...
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "codex:app-server/websocket@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "connect"]
                        fn wit_import4(
                            _: *mut u8,
            ...
            pub fn send(handle: u32, data: &str) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            pub fn recv(handle: u32) -> Result<Option<_rt::String>, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
        ...
        pub mod credential_store {
            ...
            pub fn load(
                ...
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "codex:app-server/credential-store@0.1.0"
                    )]
                    unsafe extern "C" {
                        #[link_name = "load"]
                        fn wit_import3(
        ...
        /// Host callback for server-to-client events.
        /// WASM calls this import when the app-server emits events (notifications,
        /// approval requests, turn updates, etc.).
        #[allow(dead_code, async_fn_in_trait, unused_imports, clippy::all)]
        pub mod event_sink {
            #[used]
            #[doc(hidden)]
            static __FORCE_SECTION_REF: fn() = super::super::super::__link_custom_section_describing_imports;
            #[allow(unused_unsafe, clippy::all)]
            /// Called by WASM when the app-server emits a server event.
            /// The JSON contains a tagged event: { "type": "notification"|"request"|"lagged", ... }
            pub fn emit_event(json: &str) -> () {
                unsafe {
                    ...
                    let len0 = vec0.len();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "codex:app-server/event-sink@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "emit-event"]
...
pub mod host {
    pub mod browser {
        ...
        pub mod actions {
            ...
            pub fn open_url(url: &str) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                    ...
                    let ptr1 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "host:browser/actions@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "open-url"]
                        fn wit_import2(_: *mut u8, _: usize, _: *mut u8);
                    }
        ...
        pub mod audio {
            ...
            pub fn list_input_devices() -> Result<_rt::Vec<_rt::String>, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "host:browser/audio@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "list-input-devices"]
                        fn wit_import1(_: *mut u8);
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import1(_: *mut u8) {
            ...
            pub fn list_output_devices() -> Result<_rt::Vec<_rt::String>, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            /// 0=I16, 1=U16, 2=F32.
            pub fn default_input_config() -> Result<(u32, u16, u8), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                    ...
                    #[link(wasm_import_module = "host:browser/audio@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "default-input-config"]
                        fn wit_import1(_: *mut u8);
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import1(_: *mut u8) {
            ...
            pub fn default_output_config() -> Result<(u32, u16, u8), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                    ...
                    #[link(wasm_import_module = "host:browser/audio@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "default-output-config"]
                        fn wit_import1(_: *mut u8);
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import1(_: *mut u8) {
            ...
            pub fn start_capture(
                ...
                unsafe {
                    ...
                    let (result1_0, result1_1, result1_2) = match device_name {
                        Some(e) => {
                            let vec0 = e;
                            let ptr0 = vec0.as_ptr().cast::<u8>();
                            let len0 = vec0.len();
            ...
            pub fn read_capture_data(
                ...
                unsafe {
                    ...
                    unsafe { wit_import1(_rt::as_i32(&capture_id), ptr0) };
                    let l2 = i32::from(*ptr0.add(0).cast::<u8>());
                    let result9 = match l2 {
                        0 => {
                            let e = {
            ...
            pub fn get_capture_peak(capture_id: u32) -> u16 {
                unsafe {
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "host:browser/audio@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "get-capture-peak"]
                        fn wit_import0(_: i32) -> i32;
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import0(_: i32) -> i32 {
                    ...
                    let ret = unsafe { wit_import0(_rt::as_i32(&capture_id)) };
                    ret as u16
                }
            }
            #[allow(unused_unsafe, clippy::all)]
            /// Stop a running capture.
            pub fn stop_capture(capture_id: u32) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            pub fn enqueue_playback(
                ...
                unsafe {
                    ...
                    unsafe {
                        wit_import2(_rt::as_i32(&player_id), ptr0.cast_mut(), len0, ptr1)
                    };
                    let l3 = i32::from(*ptr1.add(0).cast::<u8>());
                    let result7 = match l3 {
                        0 => {
            ...
            pub fn clear_playback(player_id: u32) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                    ...
                    unsafe { wit_import1(_rt::as_i32(&player_id), ptr0) };
                    let l2 = i32::from(*ptr0.add(0).cast::<u8>());
                    let result6 = match l2 {
                        0 => {
                            let e = ();
            ...
            #[allow(unused_unsafe, clippy::all)]
            /// Stop playback.
            pub fn stop_playback(player_id: u32) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_codex_app_server_impl {
    ($ty:ident) => {
...
\0\x0aget-stderr\x01\x03\x03\0\x15wasi:cli/stderr@0.2.9\x05\x09\x01B\x0a\x01o\x02\
...
wasi:cli/environment@0.2.9\x05\x0a\x01B\x03\x01j\0\0\x01@\x01\x06status\0\x01\0\x04\
\0\x04exit\x01\x01\x03\0\x13wasi:cli/exit@0.2.9\x05\x0b\x01B\x01\x04\0\x0etermin\
al-input\x03\x01\x03\0\x1dwasi:cli/terminal-input@0.2.9\x05\x0c\x01B\x01\x04\0\x0f\
terminal-output\x03\x01\x03\0\x1ewasi:cli/terminal-output@0.2.9\x05\x0d\x02\x03\0\
\x08\x0eterminal-input\x01B\x06\x02\x03\x02\x01\x0e\x04\0\x0eterminal-input\x03\0\
\0\x01i\x01\x01k\x02\x01@\0\0\x03\x04\0\x12get-terminal-stdin\x01\x04\x03\0\x1dw\
asi:cli/terminal-stdin@0.2.9\x05\x0f\x02\x03\0\x09\x0fterminal-output\x01B\x06\x02\
...
l-stderr@0.2.9\x05\x12\x01B\x0f\x02\x03\x02\x01\x03\x04\0\x08pollable\x03\0\0\x01\
...
k@0.2.9\x05\x14\x02\x03\0\x0d\x08duration\x01B\xc1\x01\x02\x03\x02\x01\x15\x04\0\
\x08duration\x03\0\0\x02\x03\x02\x01\x05\x04\0\x0cinput-stream\x03\0\x02\x02\x03\
\x02\x01\x07\x04\0\x0doutput-stream\x03\0\x04\x02\x03\x02\x01\x02\x04\0\x08io-er\
ror\x03\0\x06\x02\x03\x02\x01\x03\x04\0\x08pollable\x03\0\x08\x01q\x0a\x03get\0\0\
...
\x16\x02\x03\0\x0f\x10outgoing-request\x02\x03\0\x0f\x0frequest-options\x02\x03\0\
\x0f\x18future-incoming-response\x02\x03\0\x0f\x0aerror-code\x01B\x0f\x02\x03\x02\
\x01\x17\x04\0\x10outgoing-request\x03\0\0\x02\x03\x02\x01\x18\x04\0\x0frequest-\
options\x03\0\x02\x02\x03\x02\x01\x19\x04\0\x18future-incoming-response\x03\0\x04\
\x02\x03\x02\x01\x1a\x04\0\x0aerror-code\x03\0\x06\x01i\x01\x01i\x03\x01k\x09\x01\
i\x05\x01j\x01\x0b\x01\x07\x01@\x02\x07request\x08\x07options\x0a\0\x0c\x04\0\x06\
handle\x01\x0d\x03\0\x20wasi:http/outgoing-handler@0.2.9\x05\x1b\x02\x03\0\x02\x05\
error\x02\x03\0\x0e\x08datetime\x01Br\x02\x03\x02\x01\x05\x04\0\x0cinput-stream\x03\
\0\0\x02\x03\x02\x01\x07\x04\0\x0doutput-stream\x03\0\x02\x02\x03\x02\x01\x1c\x04\
\0\x05error\x03\0\x04\x02\x03\x02\x01\x1d\x04\0\x08datetime\x03\0\x06\x01w\x04\0\
...
system-error-code\x01T\x03\0\x1bwasi:filesystem/types@0.2.9\x05\x1e\x02\x03\0\x11\
\x0adescriptor\x01B\x07\x02\x03\x02\x01\x1f\x04\0\x0adescriptor\x03\0\0\x01i\x01\
\x01o\x02\x02s\x01p\x03\x01@\0\0\x04\x04\0\x0fget-directories\x01\x05\x03\0\x1ew\
asi:filesystem/preopens@0.2.9\x05\x20\x01B\x05\x01p}\x01@\x01\x03lenw\0\0\x04\0\x10\
get-random-bytes\x01\x01\x01@\0\0w\x04\0\x0eget-random-u64\x01\x02\x03\0\x18wasi\
:random/random@0.2.9\x05!\x01B\x03\x01o\x02ww\x01@\0\0\0\x04\0\x0dinsecure-seed\x01\
\x01\x03\0\x1fwasi:random/insecure-seed@0.2.9\x05\"\x01B\x0d\x01o\x02ss\x01p\0\x01\
r\x02\x03cwds\x04vars\x01\x04\0\x08exec-env\x03\0\x02\x01p}\x01r\x03\x09exit-cod\
...
timeout-ms\x09\0\x0a\x04\0\x04exec\x01\x0b\x03\0!codex:app-server/shell-exec@0.1\
.0\x05#\x01B$\x01ps\x01o\x02ss\x01p\x01\x01r\x05\x0aprocess-ids\x04argv\0\x03cwd\
s\x03env\x02\x03tty\x7f\x04\0\x10pty-start-params\x03\0\x03\x01r\x01\x0aprocess-\
ids\x04\0\x10pty-start-result\x03\0\x05\x01p}\x01r\x02\x03seqw\x04data\x07\x04\0\
\x10pty-output-chunk\x03\0\x08\x01p\x09\x01kz\x01ks\x01r\x06\x06chunks\x0a\x08ne\
xt-seqw\x06exited\x7f\x09exit-code\x0b\x06closed\x7f\x07failure\x0c\x04\0\x0fpty\
-read-result\x03\0\x0d\x01m\x04\x08accepted\x0funknown-process\x0cstdin-closed\x08\
starting\x04\0\x0cwrite-status\x03\0\x0f\x01r\x01\x06status\x10\x04\0\x10pty-wri\
te-result\x03\0\x11\x01j\x01\x06\x01s\x01@\x01\x06params\x04\0\x13\x04\0\x05star\
t\x01\x14\x01kw\x01ky\x01j\x01\x0e\x01s\x01@\x04\x0aprocess-ids\x09after-seq\x15\
\x09max-bytes\x16\x07wait-ms\x15\0\x17\x04\0\x04read\x01\x18\x01j\x01\x12\x01s\x01\
@\x02\x0aprocess-ids\x04data\x07\0\x19\x04\0\x05write\x01\x1a\x01j\0\x01s\x01@\x01\
\x0aprocess-ids\0\x1b\x04\0\x09terminate\x01\x1c\x01j\x01w\x01s\x01@\x01\x0aproc\
ess-ids\0\x1d\x04\0\x09poll-wake\x01\x1e\x03\0\x20codex:app-server/shell-pty@0.1\
.0\x05$\x01B\x0f\x01ps\x01j\x01y\x01s\x01@\x02\x03urls\x09protocols\0\0\x01\x04\0\
\x07connect\x01\x02\x01j\0\x01s\x01@\x02\x06handley\x04datas\0\x03\x04\0\x04send\
\x01\x04\x01ks\x01j\x01\x05\x01s\x01@\x01\x06handley\0\x06\x04\0\x04recv\x01\x07\
\x01@\x01\x06handley\x01\0\x04\0\x05close\x01\x08\x01@\x01\x06handley\0\x7f\x04\0\
\x09is-closed\x01\x09\x03\0\x20codex:app-server/websocket@0.1.0\x05%\x01B\x03\x01\
j\0\x01s\x01@\x01\x03urls\0\0\x04\0\x08open-url\x01\x01\x03\0\x1ahost:browser/ac\
tions@0.1.0\x05&\x01B\x06\x01j\x01s\x01s\x01@\0\0\0\x04\0\x09read-text\x01\x01\x01\
j\0\x01s\x01@\x01\x04texts\0\x02\x04\0\x0awrite-text\x01\x03\x03\0\x1chost:brows\
er/clipboard@0.1.0\x05'\x01B\x1d\x01ps\x01j\x01\0\x01s\x01@\0\0\x01\x04\0\x12lis\
t-input-devices\x01\x02\x04\0\x13list-output-devices\x01\x02\x01o\x03y{}\x01j\x01\
\x03\x01s\x01@\0\0\x04\x04\0\x14default-input-config\x01\x05\x04\0\x15default-ou\
tput-config\x01\x05\x01ks\x01j\x01y\x01s\x01@\x03\x0bdevice-name\x06\x0bsample-r\
atey\x08channels{\0\x07\x04\0\x0dstart-capture\x01\x08\x01p}\x01j\x01\x09\x01s\x01\
@\x01\x0acapture-idy\0\x0a\x04\0\x11read-capture-data\x01\x0b\x01@\x01\x0acaptur\
e-idy\0{\x04\0\x10get-capture-peak\x01\x0c\x01j\0\x01s\x01@\x01\x0acapture-idy\0\
\x0d\x04\0\x0cstop-capture\x01\x0e\x04\0\x0estart-playback\x01\x08\x01@\x02\x09p\
layer-idy\x04data\x09\0\x0d\x04\0\x10enqueue-playback\x01\x0f\x01@\x01\x09player\
-idy\0\x0d\x04\0\x0eclear-playback\x01\x10\x04\0\x0dstop-playback\x01\x10\x03\0\x18\
host:browser/audio@0.1.0\x05(\x01B\x04\x01@\x01\x03msgs\x01\0\x04\0\x03log\x01\0\
\x04\0\x04warn\x01\0\x04\0\x05error\x01\0\x03\0\x1ahost:console/logging@0.1.0\x05\
)\x01B\x0a\x01ks\x01j\x01\0\x01s\x01@\x02\x07services\x07accounts\0\x01\x04\0\x04\
load\x01\x02\x01j\0\x01s\x01@\x03\x07services\x07accounts\x05values\0\x03\x04\0\x04\
save\x01\x04\x01j\x01\x7f\x01s\x01@\x02\x07services\x07accounts\0\x05\x04\0\x11d\
elete-credential\x01\x06\x03\0'codex:app-server/credential-store@0.1.0\x05*\x01B\
