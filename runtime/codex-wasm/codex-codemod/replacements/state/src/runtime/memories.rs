...
WHERE id = ? AND memory_mode != 'polluted'
        ...
        let selected_for_phase2 = sqlx::query_scalar::<sqlx::Sqlite, i64>(
            r#"
...
VALUES (?, ?, ?, ?, ?)
    ...
    async fn prune_stage1_outputs_for_retention_prunes_stale_unselected_rows_only() {
        ...
        let before_jobs_count =
            sqlx::query_scalar::<sqlx::Sqlite, i64>("SELECT COUNT(*) FROM jobs WHERE kind = 'memory_stage1'")
                .fetch_one(runtime.pool.as_ref())
                .await
        ...
        let remaining = sqlx::query_scalar::<sqlx::Sqlite, String>(
