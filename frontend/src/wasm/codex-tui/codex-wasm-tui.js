...
const trampoline61 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5) {
  let variant1;
  if (arg0) {
    var ptr0 = arg1;
    var len0 = arg2;
...
const trampoline66 = new WebAssembly.Suspending(async function(arg0, arg1) {
...
const trampoline67 = new WebAssembly.Suspending(async function(arg0) {
...
const trampoline68 = new WebAssembly.Suspending(async function(arg0) {
...
const trampoline70 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5) {
  let variant1;
  if (arg0) {
    var ptr0 = arg1;
    var len0 = arg2;
...
const trampoline73 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  var len2 = arg3;
...
const trampoline74 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  let variant1;
...
const trampoline75 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  var ptr1 = arg2;
...
const trampoline76 = new WebAssembly.Suspending(async function(arg0, arg1, arg2) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
...
const trampoline87 = new WebAssembly.Suspending(async function(arg0, arg1) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
const trampoline90 = new WebAssembly.Suspending(async function(arg0, arg1) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
const trampoline91 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
function trampoline92(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
const trampoline93 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
const trampoline95 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
const trampoline96 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
const trampoline97 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
function trampoline99(arg0, arg1, arg2, arg3, arg4) {
  var handle1 = arg0;
  var rep2 = handleTable13[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable13.get(rep2);
  if (!rsc0) {
...
const trampoline107 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable2[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable2.get(rep2);
  if (!rsc0) {
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    ...
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'codex:tui/shell-pty@0.1.0': {
        'poll-wake': exports0['35'],
        read: exports0['37'],
        start: exports0['36'],
        terminate: exports0['39'],
        write: exports0['38'],
      },
      ...
      'host:browser/actions@0.1.0': {
        'open-url': exports0['34'],
      },
      'host:browser/audio@0.1.0': {
        'clear-playback': exports0['23'],
        'default-input-config': exports0['28'],
        'default-output-config': exports0['27'],
        'enqueue-playback': exports0['32'],
        'list-input-devices': exports0['31'],
        'list-output-devices': exports0['30'],
        'read-capture-data': exports0['29'],
        'start-capture': exports0['24'],
      ...
      'wasi:cli/terminal-stderr@0.2.0': {
        'get-terminal-stderr': exports0['68'],
      },
      'wasi:cli/terminal-stdin@0.2.0': {
        'get-terminal-stdin': exports0['66'],
      },
      'wasi:cli/terminal-stdout@0.2.0': {
        'get-terminal-stdout': exports0['67'],
      },
      ...
      'wasi:filesystem/types@0.2.0': {
        ...
        '[method]descriptor.create-directory-at': exports0['53'],
        '[method]descriptor.get-flags': exports0['48'],
        '[method]descriptor.metadata-hash': exports0['62'],
        '[method]descriptor.metadata-hash-at': exports0['63'],
        '[method]descriptor.open-at': exports0['57'],
        '[method]descriptor.read-directory': exports0['51'],
        '[method]descriptor.read-via-stream': exports0['45'],
        '[method]descriptor.readlink-at': exports0['58'],
        '[method]descriptor.remove-directory-at': exports0['59'],
        '[method]descriptor.rename-at': exports0['60'],
        '[method]descriptor.set-size': exports0['49'],
        '[method]descriptor.set-times': exports0['50'],
        '[method]descriptor.set-times-at': exports0['56'],
        '[method]descriptor.stat': exports0['54'],
        '[method]descriptor.stat-at': exports0['55'],
        '[method]descriptor.sync': exports0['52'],
        '[method]descriptor.unlink-file-at': exports0['61'],
        '[method]descriptor.write-via-stream': exports0['46'],
        '[method]directory-entry-stream.read-directory-entry': exports0['64'],
    ...
    ({ exports: exports2 } = yield instantiateCore(yield module1, {
      ...
      'wasi:io/streams@0.2.6': {
        '[method]output-stream.blocking-write-and-flush': exports0['71'],
        '[resource-drop]output-stream': trampoline22,
      },
